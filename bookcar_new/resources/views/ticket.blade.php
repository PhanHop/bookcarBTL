            ...
            <div class="filter-search">
                ...
                <div class="filter-type-checkbox">
                    <div id="" class="filter-checkbox">
                        ...
                        <div class="filter-garaname">
                            <input type="checkbox" name="" id="" {{Request::get('m') == $mediaItem->id?"checked='checked'" : ''}}>
                            <a class="filter-checkbox-after" href="{{request()->fullUrlWithQuery(['m'=>$mediaItem->id])}}">{{$mediaItem->media_type_name}}</a>
                        </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="filter-rate filter-type-checkbox">
                    <div id="btn-rate">
                        <a class="btn-rate-item {{Request::get('r') == 5?'show-color-star' : ''}}" id="five-stars" href="{{request()->fullUrlWithQuery(['r'=>'5'])}}">
                            @for ($i = 0; $i < 5; $i++) <i class="fas fa-star star-color"></i>
                                @endfor
                        </a>
                        <a class="btn-rate-item {{Request::get('r') == "4"?'show-color-star' : ''}}" id="four-stars" href="{{request()->fullUrlWithQuery(['r'=>'4'])}}">
                            @for ($i = 0; $i < 4; $i++) <i class="fas fa-star star-color"></i>
                                @endfor
                                <i class="far fa-star star-color"></i>
                                <span class="star-color"> trở lên</span>
                        </a>
                        <a class="btn-rate-item {{Request::get('r') == "3"?'show-color-star' : ''}}" id="three-stars" href="{{request()->fullUrlWithQuery(['r'=>'3'])}}">
                        ...
                        <a class="btn-rate-item {{Request::get('r') == "2"?'show-color-star' : ''}}" id="two-stars" href="{{request()->fullUrlWithQuery(['r'=>'2'])}}">
                            <i class="fas fa-star star-color"></i>
                            <i class="fas fa-star star-color"></i>
                            <i class="far fa-star star-color"></i>
                            <i class="far fa-star star-color"></i>
                        ...
                        <a class="btn-rate-item {{Request::get('r') == "1"?'show-color-star' : ''}}" id="one-stars" href="{{request()->fullUrlWithQuery(['r'=>'1'])}}">
                            <i class="fas fa-star star-color"></i>
                            <i class="far fa-star star-color"></i>
                            <i class="far fa-star star-color"></i>
                            <i class="far fa-star star-color"></i>
